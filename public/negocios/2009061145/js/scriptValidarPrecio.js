function loadScannerValidarPrecio(){
	var x = document.getElementById("txtCodigoBarrasValidarPrecio");
	x.value = "";
	const $resultados = document.querySelector("#txtCodigoBarrasValidarPrecio");
	Quagga.init({
		inputStream: {
			constraints: {
				width: 1920,
			...
			name: "Live",
			type: "LiveStream",
			target: document.querySelector('#contenedorValidarPrecio'), // Pasar el elemento del DOM
		},
		decoder: {
